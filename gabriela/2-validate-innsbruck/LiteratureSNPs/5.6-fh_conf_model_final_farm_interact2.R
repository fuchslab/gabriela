...
env.if = "fh_conf_env_snps_farm.interact2"
...
# unweighted
print(roc.a <- lapply(1:5, function(z) loss.roc(y=response.inn, pred=obj.fin[[z]]$pred.inn, ci=TRUE)))
...
print(roc.a.farm.inn <- lapply(1:5, function(z) loss.roc(y= dat.outcome$dd_asthma[test.fin.ind][ind.farm.in.inn], pred=obj.fin[[z]]$pred.inn[ind.farm.in.inn], ci=TRUE)))
