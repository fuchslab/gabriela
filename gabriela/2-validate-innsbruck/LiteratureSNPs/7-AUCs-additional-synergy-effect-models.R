...
save(all.aucs.syn, file=paste0("2-LearningMethods/Results19/aucs/all.aucs_for_synergy_models_with.tests.",B ,"bootstrap_samples.rda"))

## check it out
all.aucs.syn$dda[ , env.ifs]


###  visualize
B=10000
# setwd("~/../../../storage/cmbstore/norbert.krautenbacher/1-Projects/2-Asthma/2-validate-innsbruck/LiteratureSNPs/")
load(paste0("~/../../../storage/cmbstore/norbert.krautenbacher/1-Projects/2-Asthma/2-validate-innsbruck/LiteratureSNPs/2-LearningMethods/Results19/aucs/all.aucs_for_synergy_models_with.tests.",B ,"bootstrap_samples.rda"))
env.ifs <- c("fh_only", "fh_conf", "fh_conf_env", "fh_conf_snps", "fh_conf_env_snps",  "both")
## check it out
all.aucs.syn$dda[ , c("method", env.ifs)]

barplot(as.matrix(all.aucs.syn$dda[ , env.ifs]), beside = T, ylim=c(0.5, 0.75), xpd=FALSE, main = "all", legend.text = all.aucs.syn$dda$method)
